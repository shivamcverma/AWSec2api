...
def scrape_all_mba_colleges(driver, total_pages=308):
    all_colleges = []
    c_count = 1  # Counter for actual (non-featured) colleges

    for page in range(1, total_pages + 1):
        if page == 1:
            url = "https://www.shiksha.com/medicine-health-sciences/colleges/colleges-india"
        else:
            url = f"https://www.shiksha.com/medicine-health-sciences/colleges/colleges-india-{page}"
...
if __name__ == "__main__":
    ...
    try:
        data = scrape_all_mba_colleges(driver, total_pages=308)
